...
export default function (_data, _trades) {
        ...
        data.push(
            {
                ...
                Date: new Date(dataItem.time._d),
                High: dataItem.high,
                Low: dataItem.low,
                Open: dataItem.open,
    ...
    // Todo: Trendline shouldn't be static like this
    var trendlineData = [
